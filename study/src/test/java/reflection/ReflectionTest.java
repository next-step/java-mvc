...
class ReflectionTest {
    ...
    void givenClass_whenInstantiatesObjectsAtRuntime_thenCorrect() throws Exception {
        ...
        final Constructor<?> constructor = questionClass.getDeclaredConstructor(String.class, String.class, String.class);

        final Constructor<?> firstConstructor = constructor;
        final Constructor<?> secondConstructor = constructor;
